        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockQuote.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/W:/GitHub/proasense-adapter-webservice/webservice-stockquote/src/wsdl/stockquote.wsdl");
        }
        WSDL_LOCATION = url;
    }
