...
public class RigloggerStream {

    public RigloggerStream(PointConfig pointConfig, long startTime, Service1Soap service1Soap, KafkaProducerOutput outputPort) {
        ...
        workers.add(new PointSoapReader(queue, pointConfig, startTime, service1Soap));
