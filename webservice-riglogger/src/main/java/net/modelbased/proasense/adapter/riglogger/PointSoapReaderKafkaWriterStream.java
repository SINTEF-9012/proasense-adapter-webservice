...
public class PointSoapReaderKafkaWriterStream {
    ...
    public PointSoapReaderKafkaWriterStream(PointConfig pointConfig, GregorianCalendar startDate, Service1Soap service1Soap, KafkaProducerOutput outputPort, boolean testEnabled) {
        ...
        workers.add(new PointKafkaWriter(queue, pointConfig, startDate, outputPort, testEnabled));
